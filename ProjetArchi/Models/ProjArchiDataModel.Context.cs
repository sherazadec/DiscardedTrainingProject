...
namespace ProjetArchi.Models
{
    ...
    public partial class ProjetArchi3DEntities : DbContext
    {
        public ProjetArchi3DEntities()
            : base("name=ProjetArchi3DEntities")
        {
        }
        ...
        public virtual DbSet<Architectes> Architectes { get; set; }
