...
namespace ProjetArchi.Views
{
    public class ModélisateursController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_model,xid")] Modélisateurs modélisateurs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_model,xid")] Modélisateurs modélisateurs)
        {
            if (ModelState.IsValid)
            {
